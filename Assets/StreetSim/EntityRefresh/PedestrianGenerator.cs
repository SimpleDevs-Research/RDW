...
namespace StreetSim {
    public class PedestrianGenerator : RVO.Generator
    {
        ...
        public RouteNode2[] startNodes;                  // The route nodes that pedestrians can start at. 
        public RouteNode2[] endNodes;                    // The route nodes that pedestrians can end at.
        ...
        private List<Pedestrian2> _allPedestrians = new();      // This is a List for all pedestrians
        private List<Pedestrian2> _activePedestrians = new();   // This is a List for all ACTIVE pedestrians
        private List<Pedestrian2> _inactivePedestrians = new();  // This is a List for all INACTIVE pedestrians
        ...
        // RouteManager2 time to process all nodes first
        ...
        protected override void GenerateAgent(int agent_index) {
            ...
            // this agent has a `Pedestrian2` component
            Pedestrian2 pedestrian = go.GetComponent<Pedestrian2>();
            if (pedestrian != null) {
                pedestrian.generator = this;
        ...
        private IEnumerator SpawnCoroutine() {
            ...
            while(true) {
                ...
                Pedestrian2 pedestrian = _inactivePedestrians[0];
                ...
                RouteNode2 startNode = startNodes[startIndex];
                RouteNode2 endNode = endNodes[endIndex];
                ...
                List<RouteNode2> route = RouteManager2.Instance.GetRoute(startNode, endNode, pedestrian.personality);
        ...
        protected override void LateUpdate() {
            ...
            Queue<Pedestrian2> toCheck = new Queue<Pedestrian2>(_activePedestrians); 
            while (toCheck.Count > 0) {
                Pedestrian2 pedestrian = toCheck.Dequeue();
