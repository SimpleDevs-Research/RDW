...
namespace StreetSim {
    public class Pedestrian2 : RVO.Robot
    {
        ...
        private List<RouteNode2> _routeTrajectory = new();
        ...
        public void SetRoute(Vector3 startPosition, Vector3 endPosition, List<RouteNode2> route) {
            // Set local cache
