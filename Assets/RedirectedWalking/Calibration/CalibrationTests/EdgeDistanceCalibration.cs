    ...
    public class EdgeDistanceCalibration : CalibrationStep
    {
        ...
        public override IEnumerator Calibrate() { 
            ...
            while(!_calibrated) {
                ...
                boundaryDistance = Mathf.Min(boundaryDistance, Boundary.Instance.playerInfo.Distance);
            ...
            Boundary.Instance.SetApproachDistance(boundaryDistance);
        ...
        public void ResetBoundaryDistance() {
            ...
            boundaryDistance = Boundary.Instance.GetDistanceToBoundary(RDW.Instance.worldCenter);
        }
